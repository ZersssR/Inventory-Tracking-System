...
<title>Service Requisition Form</title>
<style>
    body {
...
<div class="container">
    ...
    <table class="details">
        <tr>
            ...
            <td>SR Number</td>
            <td><input type="text" name="sr_no" class="input-field"></td>
        </tr>
        <tr>
            <td>Project Title:</td>
    ...
    <table class="item-list">
        ...
        <tbody id="item-body">
            <tr>
                ...
                <td class="action-column"><button type="button" class="btnremove" onclick="removeRow(this)">Remove</button></td> <!-- Add class here -->
            </tr>
        </tbody>
    </table>
...
<script>
    ...
    function addRow() {
        ...
        newRow.innerHTML = `
                ...
                <td><input type="text" name="item_description[]" class="input-field"></td>
                <td><input type="text" name="size[]" class="input-field"></td>
                <td><input type="number" name="duration[]" class="input-field"></td>
                <td><input type="number" name="quantity[]" class="input-field"></td>
                <td><input type="text" name="uom[]" class="input-field"></td>
                <td><input type="text" name="pg[]" class="input-field"></td>
                <td><input type="text" name="remarks[]" class="input-field"></td>
